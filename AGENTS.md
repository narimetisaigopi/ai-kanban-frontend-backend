...
- implement all the required apis in the frontend
- implement simple authentication with email and password
- implement chatting functionality with openrouter and use 'Nex-N2-Pro (free)' free model, key present inside .env with OPENROUTER_API_KEY
...
- use backend as python fastapi with latest standards
- setup docker for running both backend and frontend
- use postgres database for storing data
- For chatting use openrouter
...
5. write 100% test covcerage for all the modules
